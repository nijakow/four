...
public class Bytecodes {
	...
	public static final byte BYTECODE_NEW = 0x0b;
	public static final byte BYTECODE_NEW_VARARGS = 0x0c;
	public static final byte BYTECODE_SCOPE = 0x0d;
	public static final byte BYTECODE_JUMP = 0x0e;
	public static final byte BYTECODE_JUMP_IF_NOT = 0x0f;
	public static final byte BYTECODE_RETURN = 0x10;
	public static final byte BYTECODE_OP = 0x11;
	public static final byte BYTECODE_LOAD_VANEXT = 0x12;
	public static final byte BYTECODE_LOAD_VACOUNT = 0x13;
	public static final byte BYTECODE_TYPE_CHECK = 0x14;
	public static final byte BYTECODE_TYPE_CAST = 0x15;
	public static final byte BYTECODE_MAKE_LIST = 0x16;
